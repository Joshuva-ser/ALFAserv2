...
const url1 = 'https://i.imgur.com/iqdBkyT.jpeg'
const url2 = 'https://i.imgur.com/iqdBkyT.jpeg'
Asena.addCommand(
    { pattern: 'ser ?(.*)', fromMe: true, desc: "Forward replied msg." },
    async (message, match) => {
        ...
        options.linkPreview = {
               ...
               sourceUrl: "http://Wa.me/918129900380?text=*ʜᴇʏ+ᦔꪮ𝘴ꫝꪊꪜꪖ+sᴇʀ+ʙɪɢғᴀɴ+💖🍃♥️*",
                }
         // ADDED */ TO REMOVE LINK PREVIEW TYPE
        options.quoted = {
            key: {
            ...
            message: {
                "imageMessage": {
                    ...
                    "caption":"₹1.0  ɪͥᴛͭsᷤ ᴍͫᴇͤ☚⃟፝★✪⃝🇦🇱𝗝𝗧𝗘𝗙𝗫✯"
                }
            }
        }
